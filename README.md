...
This project is an MCP (Model Context Protocol) Server for the given OpenAPI URL - https://api.apis.guru/v2/specs/amentum.space/global-magnet/1.3.0/openapi.json, auto-generated using AG2's [MCP builder](https://mcp.ag2.ai).
